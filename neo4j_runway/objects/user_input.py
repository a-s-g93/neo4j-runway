...
class UserInput(BaseModel):
    ...
    general_description: str = Field(default="", description="A general description of the CSV data.")
    column_descriptions: Dict[str, str] = Field(description="A mapping of the desired csv columns to their descriptions.")
