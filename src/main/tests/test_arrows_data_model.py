...
class TestDataModel(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.data_model = DataModel(nodes=cls.good_nodes, relationships=cls.good_relationships)
    ...
    def test_json_generation(self) -> None:
        ...
        with open(f"./{file_name}.json", "r") as f:
                ...
                adm_copy = ArrowsDataModel(nodes=content['nodes'], relationships=content['relationships'])
