...
```
{% include figure popup=true image_path="./assets/images/countries-single-first-model-0.12.0.svg" alt="first-model" %}
...
gdm.current_model.visualize()
```
{% include figure popup=true image_path="./assets/images/countries-single-second-model-0.12.0.svg" alt="first-model" %}
...
![countries-graph.png](./assets/images/countries-single-0.12.0.png)
