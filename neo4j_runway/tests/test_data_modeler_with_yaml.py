...
class TestGraphDataModelerWithYaml(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        data_model = DataModel(nodes=data_model_dict["nodes"], relationships=data_model_dict["relationships"])
        user_input = UserInput(general_description="this is dummy data.", column_descriptions={"prop_"+str(i): "" for i in range(1, 8)})
