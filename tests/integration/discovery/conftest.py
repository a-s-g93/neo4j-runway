...
@pytest.fixture(scope="function")
def mock_llm_async() -> MagicMock:
    m = MagicMock(spec=OpenAIDiscoveryLLM)
    m.is_async = True
    m._get_discovery_response.return_value = "test discovery content"
