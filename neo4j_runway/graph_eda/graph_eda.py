...
class GraphEDA:
    ...
    def __init__(self, graph: Optional[Neo4jGraph] = None):
        ...
        self._report = "no report generated"
    ...
    def create_eda_report(
        ...
        if show_report:
            print(report) if not notebook else display(Markdown(report))
    ...
    def report(self) -> str:
        """
        The EDA report generated by the `create_eda_report` method.

        Returns
        -------
        str
            A report, if generated
        """
        return self._report
