    ...
    Node(
        ...
        properties=[
            Property(
                ...
                type="str",
                csv_mapping="id",
                csv_mapping_other="a_id",
                is_unique=True,
            ),
            Property(name="b", type="str", csv_mapping="b"),
        ],
        source_name="a.csv",
    ),
    Node(
        label="LabelB",
        properties=[
            Property(name="id", type="str", csv_mapping="id", is_unique=True),
            Property(name="c", type="str", csv_mapping="c"),
        ],
        source_name="b.csv",
    ),
]
...
#                     name="stateId",
#                     type="int",
#                     csv_mapping="state_id",
#                     csv_mapping_other="id",
#                     is_unique=False,
#                     part_of_key=True,
#                 ),
#                 Property(
