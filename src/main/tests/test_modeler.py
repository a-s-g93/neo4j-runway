...
nodes2 = nodes+[Node(label="Test", properties=[Property(name="name", type="str", csv_mapping="test", is_unique=True)])] 
...
class TestGraphDataModler(unittest.TestCase):
    ...
    def test_get_model(self) -> None:
        ...
        self.assertEqual(self.gdm.get_model(version=1, as_dict=True), data_model.model_dump())
