...
test_model_valid = {'Nodes': [{'Label': 'Loan',
...
test_model_invalid = {'Nodes': [{'Label': 'Loan',
...
test_columns = ['BorrowerName', 'BusinessType', 'LoanNumber', 'CurrentApprovalAmount', 'JobsReported', 
                'ProjectState', 'OriginatingLender', 'UTILITIES_PROCEED', 'PAYROLL_PROCEED', 'MORTGAGE_INTEREST_PROCEED', 
